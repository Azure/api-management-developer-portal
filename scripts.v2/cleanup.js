...
async function getContentTypes() {
    try {
        const data = await request("GET", `https://${managementApiEndpoint}/subscriptions/00000/resourceGroups/00000/providers/Microsoft.ApiManagement/service/00000/contentTypes?api-version=2021-08-01`, managementApiAccessToken);
...
async function getContentItems(contentType) {
    try {
        const data = await request("GET", `https://${managementApiEndpoint}/subscriptions/00000/resourceGroups/00000/providers/Microsoft.ApiManagement/service/00000/contentTypes/${contentType}/contentItems?api-version=2021-08-01`, managementApiAccessToken);
    ...
    try {
        ...
        for (const contentType of contentTypes) {
            ...
            for (const contentItem of contentItems) {
                await request("DELETE", `https://${managementApiEndpoint}/subscriptions/00000/resourceGroups/00000/providers/Microsoft.ApiManagement/service/00000/${contentItem.id}?api-version=2021-08-01`, managementApiAccessToken);
            }
        }
    }
    catch (error) {
