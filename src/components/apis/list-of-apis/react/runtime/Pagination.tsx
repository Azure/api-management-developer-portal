...
export const Pagination = ({pageNumber, setPageNumber, pageMax}: PaginationProps) => (
    <>
        <Button appearance="transparent" onClick={() => setPageNumber(1)} disabled={pageNumber === 1} icon={<ChevronLDouble />}/>
        <Button appearance="transparent" onClick={() => setPageNumber(prev => prev - 1)} disabled={pageNumber === 1} icon={<ChevronL />}/>
        ...
        <Button appearance="transparent" onClick={() => setPageNumber(prev => prev + 1)} disabled={pageNumber === pageMax} icon={<ChevronR />}/>
        <Button appearance="transparent" onClick={() => setPageNumber(pageMax)} disabled={pageNumber === pageMax} icon={<ChevronRDouble />}/>
    </>
)
