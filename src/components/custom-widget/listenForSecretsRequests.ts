...
import { dataApiVersion, managementApiVersion, SettingNames } from "../../constants";
...
export class ListenForSecretsRequests {
    constructor(
        ...
        window.addEventListener("message", async ({ data }) => {
            ...
            const managementApiUrl = (await settingsProvider.getSetting<string>(SettingNames.backendUrl)) || `${ensureTrailingSlash(window.location.origin)}mapi`;
