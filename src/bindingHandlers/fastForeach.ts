...
//code from https://github.com/brianmhunt/knockout-fast-foreach/blob/master/dist/knockout-fast-foreach.js
...
const commentNodesHaveTextProperty = document && document.createComment("test").data === "<!--test-->";
